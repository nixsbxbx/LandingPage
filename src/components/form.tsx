...
export const Form = () => {
    return (
        <div className="mb[300px] absolute absolute top-[-200px] left-0 right-0 mx-auto text-center py-10 px-6 bg-Navy-850 rounded-[9px] w-[336px] ">
            ...
            <form className="flex flex-col gap-6" action="">
                <input className="bg-white rounded-3x1
